...
class CustomValidator  {
    ...
    companion object {
         ...
         */
        fun isValidEmail(data: String, updateUI: Boolean = true): Boolean {
            val str = getText(data)
         ...
         */
        fun isValidPassword(editText : EditText, data: String, updateUI: Boolean = true): Boolean {
            val str = getText(data)
            var valid = true
            ...
            if (updateUI) {
                ...
                setError(editText, error)
            }

            return valid
        }

        fun setError(data: EditText, error: String?) {
//            if (data is EditText) {
